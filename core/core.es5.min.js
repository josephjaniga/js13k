...
var Game = (function () {
    function Game(options) {
        ...
        this.init = function () {
            ...
            // setup
            _this.SpawnPlayer(new _Vector2Js2["default"](280, 0), new _Vector2Js2["default"](12, 12));
            _this.SpawnPlatform(new _Vector2Js2["default"](160, 90), new _Vector2Js2["default"](320, 30));
            _this.SpawnCatch();
        ...
        this.SpawnPlatform = function (position, size) {
            ...
            deadArea.transform = new _TransformJs2["default"]({
                position: new _Vector2Js2["default"](position.x + size.x, position.y + 2),
                size: new _Vector2Js2["default"](1, size.y - 4)
            });
            deadArea.AddComponent(new _ColliderJs2["default"]());
            deadArea.AddComponent(new _ScrollingTerrainJs2["default"]());
...
var Player = (function (_Component) {
    ...
    function Player(options) {
        ...
        this.Die = function () {
            ...
            _GameJs2["default"].instance.reset();
...
var ScrollingTerrain = (function (_Component) {
    ...
    function ScrollingTerrain(options) {
        ...
        this.Update = function () {
            ...
            if (_this.link === null && _this.gameObject.name === "Platform") {

                var newSize = new _Vector2Js2["default"](_this.RandomRange(80, 320), 30),
                    newPositionX = _this.gameObject.transform.position.x - newSize.x - _this.RandomRange(100, 0),
                ...
                if (newPositionY > _this.gameObject.transform.position.y) {
                    ...
                    var additionalDistance = newPositionY - _this.gameObject.transform.position.y;
