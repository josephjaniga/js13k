...
var _classPlatformSpawnerJs = require("./class/PlatformSpawner.js");

var _classPlatformSpawnerJs2 = _interopRequireDefault(_classPlatformSpawnerJs);
...
var canvas = document.getElementById("view"),
    _input = new _classInputJs2["default"](),
...
// setup the player
var player = new _classGameObjectJs2["default"]();
player.transform = new _classTransformJs2["default"]({
    position: new _classVector2Js2["default"](280, 0),
    size: new _classVector2Js2["default"](20, 20)
});
player.AddComponent(new _classColliderJs2["default"]());
player.AddComponent(new _classPhysicsBodyJs2["default"]({ kinematic: false }));
player.AddComponent(new _classJumpJs2["default"]({ input: _input }));
player.AddComponent(new _classSpriteRendererJs2["default"]());
player.color = Color.transparent;
player.name = "Player";

// setup the floor
var floor = new _classGameObjectJs2["default"]();
floor.transform = new _classTransformJs2["default"]({
    position: new _classVector2Js2["default"](0, 180),
    size: new _classVector2Js2["default"](160, 20)
});
floor.AddComponent(new _classColliderJs2["default"]());
floor.AddComponent(new _classScrollingTerrainJs2["default"]());
floor.AddComponent(new _classRectRendererJs2["default"]());
floor.color = Color.light;
floor.name = "Floor";

// add a platform spawner
var platformSpawner = new _classGameObjectJs2["default"]();
platformSpawner.transform = new _classTransformJs2["default"]({
    position: new _classVector2Js2["default"](0, 0),
    size: new _classVector2Js2["default"](0, 0)
});
...
},{"./GameObject.js":5,"./Vector2.js":15}],5:[function(require,module,exports){
"use strict";
...
var GameObject = function GameObject() {
    ...
    this.isOnScreen = function () {
        var t = _this.transform,
            status = false;
        if (t.position.x + t.size.x > 0 && t.position.x < _GameJs2["default"].instance.resolution.x && t.position.y + t.size.y > 0 && t.position.y < _GameJs2["default"].instance.resolution.y) {
            status = true;
        }
        return status;
    };
...
var Jump = (function (_Component) {
    ...
    function Jump(options) {
        ...
        this.Update = function () {
            ...
            if (_this.input.isSpaceDown && _this.pb && _this.pb.grounded) {
                _this.gameObject.color = "#FF0000";
                _this.pb.velocity.y = -12;
                _this.pb.grounded = false;
            } else {
                _this.gameObject.color = "#000000";
            }
...
var PhysicsBody = (function (_Component) {
    ...
    function PhysicsBody(options) {
        ...
        this.gravity = new _Vector2Js2["default"](0, 0.5);
...
var PlatformSpawner = (function (_Component) {
    _inherits(PlatformSpawner, _Component);

    function PlatformSpawner(options) {
        var _this = this;

        _classCallCheck(this, PlatformSpawner);

        _get(Object.getPrototypeOf(PlatformSpawner.prototype), "constructor", this).call(this, options);
...
},{"./Component.js":3,"./Game.js":4}],13:[function(require,module,exports){
"use strict";
...
var SpriteRenderer = (function (_Component) {
    ...
    function SpriteRenderer(options) {
        ...
        this.animations = [{ name: "Walk", frames: [0, 1, 2, 3] }, { name: "Jump", frames: [4] }];
