...
player.AddComponent(new _classPhysicsBodyJs2["default"]());
...
floor.transform = new _classTransformJs2["default"]({
    position: new _classVector2Js2["default"](0, 150),
    size: new _classVector2Js2["default"](320, 20)
});
floor.AddComponent(new _classPhysicsBodyJs2["default"]({ "kinematic": true }));
...
},{"./class/Collider.js":2,"./class/Component.js":3,"./class/Game.js":4,"./class/GameObject.js":5,"./class/Input.js":6,"./class/Jump.js":7,"./class/PhysicsBody.js":8,"./class/Rect.js":9,"./class/Transform.js":10,"./class/Vector2.js":11}],2:[function(require,module,exports){
"use strict";
...
var Game = (function () {
    function Game(options) {
        ...
        this.init = function (options) {
            ...
            // PROPERTIES
            var scale = 3;
            _this.resolution = new _Vector2Js2["default"](320 * scale, 188 * scale);
            _this.CTX = _this.canvas.getContext('2d');
            _this.objs = [];
            _this.ResizeCanvas(_this.resolution.x, _this.resolution.y);
...
},{"./GameObject.js":5,"./Vector2.js":11}],5:[function(require,module,exports){
"use strict";
...
},{"./Transform.js":10,"./Vector2.js":11}],6:[function(require,module,exports){
'use strict';
...
var PhysicsBody = (function (_Component) {
    ...
    function PhysicsBody(options) {
        ...
        this.gravity = new _Vector2Js2["default"](0, 1);
        ...
        this.Step = function () {
            ...
            // drag?
            _this.velocity.x *= 0.7;
            _this.velocity.y *= 0.7;
            ...
            var col = false,
                ...
                myRect = new _RectJs2["default"](t.position.x + _this.velocity.x, t.position.y + _this.velocity.y, t.size.x, t.size.y);

            // check if new position has collision?
            if (!_this.collider !== null) {
                _GameJs2["default"].objs.forEach(function (object) {
                    var t2 = object.transform,
                        objRect = new _RectJs2["default"](t2.position.x, t2.position.y, t2.size.x, t2.size.y);
                    if (_this.AABB(myRect, objRect)) {
                        col = true;
                    }
                });
            }
...
},{"./Component.js":3,"./Game.js":4,"./Rect.js":9,"./Vector2.js":11}],9:[function(require,module,exports){
'use strict';
...
},{"./Vector2.js":11}],10:[function(require,module,exports){
"use strict";
