...
var Game = (function () {
    function Game(options) {
        ...
        this.init = function (options) {
            ...
            // setup
            _this.SpawnPlayer(new _Vector2Js2["default"](280, 0), new _Vector2Js2["default"](20, 20));
            _this.SpawnPlatform(new _Vector2Js2["default"](160, 90), new _Vector2Js2["default"](320, 20));
...
var ScrollingTerrain = (function (_Component) {
    ...
    function ScrollingTerrain(options) {
        ...
        this.Update = function () {
            ...
            if (_this.link === null && _this.gameObject.transform.position.x > 0) {

                var newSize = new _Vector2Js2["default"](_this.RandomRange(160, 80), 20),
                    newPositionX = _this.gameObject.transform.position.x - newSize.x,
                    newPositionY = _this.gameObject.transform.position.y + _this.RandomRange(20, -20);
...
},{"./Component.js":3,"./Game.js":4,"./Vector2.js":14}],12:[function(require,module,exports){
"use strict";
